...
WHERE NOT EXISTS (SELECT 1 FROM users WHERE username = 'hr' OR email = 'hr@company.com');
...
WHERE NOT EXISTS (SELECT 1 FROM users WHERE username = 'employee' OR email = 'employee@company.com');
